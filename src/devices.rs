use crate::{
    device::DeviceInit, impl_device_encoder_module, impl_device_gpio_module,
    impl_device_neopixel_module, seesaw_device, EncoderModule, GpioModule, NeopixelModule, PinMode,
    StatusModule,
};
...
impl<D: crate::Driver> NeoKey1x4<D> {
