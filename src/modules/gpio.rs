...
#[allow(dead_code)]
const SET_OUTPUT: &Reg = &[MODULE_GPIO, 0x02];

/// WO - 32 bits
/// Writing a 1 to any bit in this register sets the direction of the
/// corresponding pin to INPUT. Writing 0 has no effect.
const SET_INPUT: &Reg = &[MODULE_GPIO, 0x03];
...
#[allow(dead_code)]
const INT_FLAG: &Reg = &[MODULE_GPIO, 0x0A];
...
/// no effect.
const PULL_ENABLE: &Reg = &[MODULE_GPIO, 0x0B];

/// WO - 32 bits
/// Writing a 1 to any bit in this register disables the pull up/down on the
/// corresponding pin. Writing 0 has no effect.
#[allow(dead_code)]
const PULL_DISABLE: &Reg = &[MODULE_GPIO, 0x0C];
