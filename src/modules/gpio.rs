...
// pub trait GpioModule<B: crate::I2cBus>: Addressable + Attached<B> {
//     fn digital_read(&mut self, pin: u8) -> Result<bool,
// SeesawError<B::I2cError>> {         self.digital_read_bulk()
...
// SeesawError<B::I2cError>> {         self.set_pin_mode_bulk(1 << pin, mode)
//     }
