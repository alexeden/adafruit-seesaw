...
// pub trait NeopixelModule<B: crate::I2cBus>: Addressable + Attached<B> {
//     const PIN: u8;
...
//     fn set_neopixel_speed(&mut self, speed: NeopixelSpeed) -> Result<(),
...
//     fn set_neopixel_color(&mut self, r: u8, g: u8, b: u8) -> Result<(),
// SeesawError<B::I2cError>> {         self.set_nth_neopixel_color(0, r, g, b)
//     }
...
//     fn sync_neopixel(&mut self) -> Result<(), SeesawError<B::I2cError>> {
//         let addr = self.addr();
